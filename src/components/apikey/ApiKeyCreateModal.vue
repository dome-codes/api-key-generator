<template>
  ...
  >
    <div class="bg-white rounded-xl shadow-2xl p-8 w-full max-w-lg relative animate-in fade-in zoom-in">
      <!-- Header mit Icon -->
      <div class="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">Erstellen Sie einen neuen geheimen Schlüssel für Ihre Anwendung</p>
        </div>
      </div>
      ...
      <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <div class="flex items-start gap-2">
          ...
          <div class="text-sm text-blue-800">
            ...
            <p>Der API-Schlüssel wird nur einmal angezeigt. Speichern Sie ihn sicher, da Sie ihn später nicht mehr einsehen können.</p>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        <div>
          ...
          />
          <p class="mt-1.5 text-xs text-gray-500">Ein beschreibender Name hilft Ihnen, den Schlüssel später wiederzufinden.</p>
        </div>
      </div>
